...
// Junk Drawer: the chat status bar entry is a GitHub Copilot status/sign-in/quota
// indicator - this fork has no Copilot, so it is not registered.
void ChatStatusBarEntry;
