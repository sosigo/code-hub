...
// Junk Drawer: this product may ship without a default chat agent; onboarding is skipped in that
// case (see show()), so defaultChat is never dereferenced when undefined.
